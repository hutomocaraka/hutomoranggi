 ...
 * @author naran
 */
public class DataBaruJadwal extends javax.swing.JFrame {

    /**
     * Creates new form DataBaruJadwal
     */
    public DataBaruJadwal() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA BARU JADWAL");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Fakultas", "Item 2", "Item 3", "Item 4" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataBaruJadwal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DataBaruJadwal().setVisible(true);
            }
        });
    }
